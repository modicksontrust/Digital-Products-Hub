      ...
      <Dialog open={!!grantUser} onOpenChange={open => !open && setGrantUser(null)}>
        <DialogContent className="rounded-2xl max-w-sm">
          ...
          <div className="space-y-3 py-2">
            ...
            <Input type="number" placeholder="Amount (use negative to deduct)" value={grantAmount} onChange={e => setGrantAmount(e.target.value)} className="rounded-xl" />
            <Input placeholder="Note (optional)" value={grantNote} onChange={e => setGrantNote(e.target.value)} className="rounded-xl" />
          </div>
